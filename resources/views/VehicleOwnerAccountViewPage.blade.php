...
<head>
    ...
    <title>Vehicle owner account</title>
...
<div class="container-fluid job_noti_nego_section img-responsive">
    <div class="row">
        ...
        <div class="col-md-offset-1 col-md-4 well">
            ...
            <form action="/edit_owner">

                <div class="form-group">
                    <span><h5>Name:</h5></span>
                    <input type="Name" class="form-control" id="importer_name" value={!! $owner['name_of_owner'] !!} readonly>
                </div>

                <div class="form-group">
                    <span><h5>Union membership number:</h5></span>
                    <input type="Name" class="form-control" id="Union Membership number" value={!! $owner['union_membership_no'] !!} readonly>
                </div>

                <div class="form-group">
                    <span><h5>Date of birth:</h5></span>
                    <input type="date" class="form-control" id="importer_Date Of Birth" value={!! $owner['date_of_birth'] !!} readonly>
                </div>

                <div class="form-group">
                    <span><h5>National ID:</h5></span>
                    <input type="Name" class="form-control" id="importer_National ID Number"
                           value={!! $owner['NIDno'] !!}  readonly>
                </div>

                <div class="form-group">
                    <span><h5>Address</h5></span>
                    <input type="Name" class="form-control" id="importer_Address" value={!! $owner['address'] !!}  readonly>
                </div>

                <div class="form-group">
                    <span><h5>Phone number:</h5></span>
                    <input type="Name" class="form-control" id="importer_Contact Number" value={!! $owner['phone'] !!}  readonly>
                </div>

                <div class="form-group">
                    <span><h5>Email address:</h5></span>
                    <input type="email" class="form-control" id="importer_Email ID" value={!! $owner['email'] !!}  readonly>
                </div>
                ...
                <div>
                    <button class="submit-btn-style btn-success btn pull-right" type="submit">Edit</button>
                </div>
