...
<head>
    ...
    <title>Importer edit profile page</title>
...
<div class="container-fluid job_noti_nego_section img-responsive">
    <div class="row">
        <div class="col-md-12">
            ...
            <!--------------------------------------------------------->
            <!-- Importer edit profile section starts -->
            ...
            <div class="tab-content">
                ...
                <!-- Importer Personal info edit section starts -->
                <div id="changeInfo" class="tab-pane fade in active">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 well">
                                ...
                                {!! Form::open(['method'=>'PATCH','route'=>['importer.update',$importer['id']]] )  !!}

                                {{ csrf_field() }}


                                <div class="form-group">
                                        <input type="Name" class="form-control" id="importer_name" name="name_of_owner" value={!! $importer['name_of_owner'] !!}>
                                    </div>

                                    <div class="form-group">
                                        <span><h5>Date of birth:</h5></span>
                                        <input type="date" class="form-control" id="importer_Date Of Birth" name="date_of_birth" value={!! $importer['date_of_birth'] !!}>
                                    </div>

                                    <div class="form-group">
                                        <input type="Name" class="form-control" id="importer_National ID Number" name="NIDno"
                                               value={!! $importer['NIDno'] !!}>
                                    </div>

                                    <div class="form-group">
                                        <input type="Name" class="form-control" id="importer_Address" name="address" value={!! $importer['address'] !!}>
                                    </div>

                                    <div class="form-group">
                                        <input type="Name" class="form-control" id="importer_Contact Number" name="phone" value={!! $importer['phone'] !!}>
                                    </div>

                                    <div class="form-group">
                                        <input type="email" class="form-control" id="importer_Email ID" name="email" value={!! $importer['email'] !!}>
                                    </div>
                ...
                <!-- Importer Personal info edit section ends -->

                <!-- Importer Bank account edit section starts -->
                ...
                <!-- Importer Bank account edit section ends -->

                <!-- Importer bKash account edit section starts -->
                ...
                <!-- Importer bKash account edit section ends -->


            </div>

            <!-- Importer edit profile section ends -->
            <!--------------------------------------------------------->
